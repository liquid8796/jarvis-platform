...
internal sealed class TaskAgentPeer : IAsyncDisposable
{
    ...
    { DeviceId = DeviceId, TaskId = taskId, Goal = plan.Goal, Project = plan.Project,
        ExecutionMode = plan.ExecutionMode, TimeoutSeconds = plan.TimeoutSeconds, Steps = plan.Steps, VerificationSpec = plan.VerificationSpec, CodingVerification = plan.CodingVerification };
